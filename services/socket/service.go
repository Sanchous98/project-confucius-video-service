...
import (
	"encoding/json"
	"github.com/Sanchous98/project-confucius-base"
...
func (s *socket) Serve(router *mux.Router) error {
	// Read index.html from disk into memory, serve whenever anyone requests /
	indexHTML, err := ioutil.ReadFile("resources/templates/index.html")
	if err != nil {
		panic(err)
	}
	...
	router.Handle("/websocket", http.HandlerFunc(websocketHandler))
	// Index handle func
